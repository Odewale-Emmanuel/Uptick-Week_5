...
export function SignInForm({
  ...
  return (
    <form
      ...
      {...props}
    >
      <div className="flex flex-col gap-6 max-w-[450px] w-full mx-auto">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <div className="h-0.5 grow bg-black/5"></div>
          <span className="block text-muted-foreground relative z-10 px-2">
            Or continue with
          </span>
          <div className="h-0.5 grow bg-black/5"></div>
        </div>
